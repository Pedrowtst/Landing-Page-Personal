...
assert.match(dumbbell3dJs, /targetProgress[\s\S]*readScrollProgress\(\)[\s\S]*smoothProgress\(state\.progress,\s*state\.targetProgress\)/, 'dumbbell renders from smoothed progress instead of raw scroll jumps');
